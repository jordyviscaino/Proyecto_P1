...
function mostrarDatosUsuario() {
  ...
  document.getElementById("correoPerfil").innerText = "Correo: " + ver_completo.email;
  document.getElementById("edadPerfil").innerText = "Edad: " + ver_completo.edad;
  document.getElementById("carreraPerfil").innerText = "Carrera: " + ver_completo.carrera;
